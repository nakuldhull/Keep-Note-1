...
public class NoteController {
	...
	public String viewPage(ModelMap model) {
		model.addAttribute("notesList", noteRepository.getAllNotes());
		return "index";
	}
	...
	*/
	...
	public String addNote(@RequestParam("noteId") Integer noteId ,@RequestParam("noteTitle") String noteTitle, @RequestParam("noteContent") String noteContent,@RequestParam("noteStatus") String noteStatus,ModelMap model) {
		Note note=noteRepository.getNoteByNoteId(noteId);
			...
			noteRepository.addNote(new Note(noteId, noteTitle, noteContent,noteStatus,LocalDateTime.now()));
		}
		model.addAttribute("notesList", noteRepository.getAllNotes());
		return "index";
				}
	...
	*/
	...
	public String updateNote(@PathVariable int noteId, ModelMap modelMap) {
		Note note=noteRepository.getNoteByNoteId(noteId);
		modelMap.addAttribute("notes", note);
		modelMap.addAttribute("notesList", noteRepository.getAllNotes());
		return "index";
	}
